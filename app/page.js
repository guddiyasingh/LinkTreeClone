  ...
  return (
   <main>
    <section className="bg-[#254f1a] min-h-[100vh] grid grid-cols-2">
        ...
        <div className=" flex items-center justify-center flex-col gap-4 ml-[10vw]">

         <p className="text-yellow-300 font-bold text-5xl"> Everything you are. In one, simple link in bio.</p>
